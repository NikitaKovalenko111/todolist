...
describe('TEST TODO ACTIONS', () => {
    ...
    test('SET TODO ACTION TEST', () => {
        ...
        expect(setTodosAC(todos)).toEqual({
    ...
    test('POST TODOS ACTION TEST', () => {
        const target: string = 'test'

        expect(postTodosAC(target, false, '1')).toEqual({
    ...
    test('PUT TODO ACTION TEST', () => {
        expect(putTodoAC(false, '1', 'test')).toEqual({
