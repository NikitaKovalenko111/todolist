    ...
    const items: MenuProps['items'] = [
        {
            key: 'profile',
            label: (
                <NavLink style={{ textAlign: 'center' }} to={`/profile/${ userId }`} >Профиль</NavLink>
            )
        },
        {
            key: 'tasks',
            label: (
                <NavLink style={{ textAlign: 'center' }} to={`/user/${ userId }`} >Задачи</NavLink>
            )
        },
        {
            key: 'users',
            label: (
                <NavLink style={{ textAlign: 'center' }} to={`/users`} >Пользователи</NavLink>
            )
        },
        {
            key: 'exit',
            label: (
                <span style={{ textAlign: 'center' }}>Выйти</span>
            ),
            danger: true,
            onClick: handleExit
        }
