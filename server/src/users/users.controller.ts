...
export class UsersController {
    ...
    @Post('/registration')
    registration(
        @Body() registrationBody: registrationDto
    ): Promise<User | string> {
        return this.usersService.registrationService(
    ...
    authorization(
        ...
        return this.usersService.authorizationService(
            authorizationDto.username,
